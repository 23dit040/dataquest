...
import { EyeIcon, EyeSlashIcon, EnvelopeIcon, LockClosedIcon, VideoCameraIcon } from '@heroicons/react/24/outline';
      ...
      <div className="max-w-md w-full">
        <div className="card">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">Sign in to join your meetings</p>
          </div>
        ...
        <div className="mt-8 text-center">
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="flex items-center justify-center space-x-2 text-sm text-gray-600">
              ...
              <span>Real-time Chat & Screen Share</span>
            </div>
            <div className="flex items-center justify-center space-x-2 text-sm text-gray-600">
              <svg className="h-5 w-5 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
              <span>Secure & Private Meetings</span>
            </div>
          </div>
        </div>
      </div>
